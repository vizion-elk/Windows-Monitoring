...
if($principal.IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    ...
    Set-Location -Path 'c:\windows-monitoring-7.7.0'
    ...
    ##Start-Job -FilePath "C:\windows-monitoring-7.7.0\scripts\auditbeatRestart.ps1"

    ##powershell.exe -windowstyle hidden -file C:\windows-monitoring-7.7.0\scripts\auditbeatRestart.ps1

    Set-Location -Path 'C:\windows-monitoring-7.7.0\scripts'
