...
if($principal.IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    ...
    Set-Location -Path 'c:\windows-monitoring-6.5.4\local\winlogbeat'
    Set-ExecutionPolicy Unrestricted
    "Winlogbeat Execution policy set - Success"

    Set-Location -Path 'c:\windows-monitoring-6.5.4\local\auditbeat'
    Set-ExecutionPolicy Unrestricted
    "Auditbeat Execution policy set - Success"

    Set-Location -Path 'c:\windows-monitoring-6.5.4\local\metricbeat'
    Set-ExecutionPolicy Unrestricted
    "Metricbeat Execution policy set - Success`n"

    Set-Location -Path 'c:\windows-monitoring-6.5.4'
    ...
    ##Start-Job -FilePath "C:\windows-monitoring-6.5.4\scripts\auditbeatRestart.ps1"

    ##powershell.exe -windowstyle hidden -file C:\windows-monitoring-6.5.4\scripts\auditbeatRestart.ps1

    Set-Location -Path 'C:\windows-monitoring-6.5.4\scripts'
